...
* [**JSON-server**](https://github.com/typicode/json-server) ⭐ 75,718 | 🐛 720 | 🌐 JavaScript | 📅 2026-03-23 可以配合 LowDB 使用 快速搭建一个 REST API
* [**lodash**](https://github.com/lodash/lodash) ⭐ 61,275 | 🐛 105 | 🌐 JavaScript | 📅 2026-09-11 前端工具函数集合
* [**dayjs**](https://github.com/xx45/dayjs) ⭐ 48,666 | 🐛 1,337 | 🌐 JavaScript | 📅 2026-09-15 一个轻量级类 moment.js API 时间库
* [**dayjs**](https://github.com/iamkun/dayjs) ⭐ 48,666 | 🐛 1,337 | 🌐 JavaScript | 📅 2026-09-15 时间处理库，不过大部分情况下我还是用自己的封装的函数
* [**tabler**](https://github.com/tabler/tabler) ⭐ 41,779 | 🐛 53 | 🌐 Astro | 📅 2026-09-25 基于 Bootstrap 4 的 Dashboard UI Kit 和美观 高颜值 ui 模板
* [**lerna**](https://github.com/lerna/lerna) ⭐ 36,055 | 🐛 297 | 🌐 TypeScript | 📅 2026-09-26 大项目版本控制工具，项目中可以有多个 package.json 文件
* [**uppy**](https://github.com/transloadit/uppy) ⭐ 31,002 | 🐛 197 | 🌐 TypeScript | 📅 2026-09-26 一个很好看的也很好用的 前端上传库
* [**fingerprintjs**](https://github.com/Valve/fingerprintjs2) ⭐ 28,518 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-24 是一个快速的浏览器指纹库，通浏览环境的一系列配置生成 id
...
* [**rxdb**](https://github.com/pubkey/rxdb) ⭐ 23,390 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-26 一款开源的快速、灵活的客户端数据库，支持各种浏览器以及 NodeJS，Electron、React 等等，是 PouthDB 之上的一个封装库
...
* [**rrweb**](https://github.com/rrweb-io/rrweb) ⭐ 20,211 | 🐛 418 | 🌐 TypeScript | 📅 2026-09-24 一个可以记录你页面中所有操作的库
...
* [DOMPurify](https://github.com/cure53/DOMPurify) ⭐ 17,414 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-26 比 sanitize-html 更轻量，建议一般业务用这个
* [**A-Programmers-Guide-to-English**](https://github.com/yujiangshui/A-Programmers-Guide-to-English) ⭐ 16,710 | 🐛 10 | 📅 2023-01-28 专为程序员编写的英语学习指南。
* [**Filepond**](https://github.com/pqina/filepond) ⭐ 16,394 | 🐛 143 | 🌐 JavaScript | 📅 2026-09-24 一个小巧的文件上传库
* [**react-jsonschema-form**](https://github.com/mozilla-services/react-jsonschema-form) ⭐ 15,907 | 🐛 115 | 🌐 TypeScript | 📅 2026-09-26 Mozilla service 开源了一个通过 JSON 直接生成表单的 React 组件
* [**gpu.js**](https://github.com/gpujs/gpu.js) ⭐ 15,469 | 🐛 66 | 🌐 JavaScript | 📅 2026-09-24 通过将 js 转为特定的 language，利用 GPU 来执行，大大提高了执行性能和速度
* [**ajv**](https://github.com/epoberezkin/ajv) ⭐ 14,841 | 🐛 380 | 🌐 TypeScript | 📅 2026-09-06 一个 json schema 验证的库
* [**flexsearch**](https://github.com/nextapps-de/flexsearch) ⭐ 13,800 | 🐛 38 | 🌐 JavaScript | 📅 2026-06-28 能让你更加高效和快速的检索文本内容
* [**primjs**](https://github.com/PrismJS/prism) ⭐ 13,042 | 🐛 496 | 🌐 JavaScript | 📅 2026-09-26 让页面支持代码高亮
...
* [**dinero.js**](https://github.com/sarahdayan/dinero.js) ⭐ 6,798 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-26 用来创建、计算和格式化货币价值的不可变的框架，支持国际化
...
* [**percollate**](https://github.com/danburzo/percollate) ⭐ 4,682 | 🐛 17 | 🌐 JavaScript | 📅 2025-08-29 命令行工具 能将网页转换成 pdf
...
* [**pretty-bytes**](https://github.com/sindresorhus/pretty-bytes) ⭐ 1,311 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-26 将字节转换成可以读的字符串，比如 1337 个字节，会显示成 1.34 KB
...
* [**animate.css**](https://github.com/daneden/animate.css) ⭐ 82,825 | 🐛 80 | 🌐 CSS | 📅 2024-07-29 最有名的动画效果库
...
* [**rough**](https://github.com/pshihn/rough) ⭐ 21,200 | 🐛 42 | 🌐 HTML | 📅 2024-07-28 基于 Canvas 的手绘风格图形库
...
* [**css-doodle**](https://github.com/css-doodle/css-doodle) ⭐ 6,049 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-25 A web component for drawing patterns with CSS 一个用于使用 CSS 绘制图案的 Web 组件
...
* [**storybook**](https://github.com/storybooks/storybook) ⭐ 91,152 | 🐛 1,865 | 🌐 TypeScript | 📅 2026-09-25
* [**docsify**](https://github.com/docsifyjs/docsify) ⭐ 31,528 | 🐛 93 | 🌐 JavaScript | 📅 2026-09-20 轻量级文档工具，但其是运行时编译的，所以 seo 不好
...
* [**strapi**](https://github.com/strapi/strapi/) ⭐ 73,237 | 🐛 579 | 🌐 TypeScript | 📅 2026-09-25 开源的解决方案来创建、部署和管理自己的 API，通过图形化界面进行操作
* [**phaser**](https://github.com/photonstorm/phaser) ⭐ 40,366 | 🐛 155 | 🌐 JavaScript | 📅 2026-08-21 这是一个为桌面和移动浏览器开发 HTML5 游戏的快速开源框架。
  你可以为 iOS、 Android 和不同的本地应用程序创建游戏。
* [**tesseract**](https://github.com/naptha/tesseract.js) ⭐ 38,738 | 🐛 53 | 🌐 JavaScript | 📅 2026-05-17 图像识别，它能识别图片中的文字，支持中文
* [**fabric.js**](https://github.com/fabricjs/fabric.js) ⭐ 31,464 | 🐛 470 | 🌐 TypeScript | 📅 2026-09-26 基于 canvas 创建交互式的图片编辑界面非常适合用来做图片合成类工作。
...
* [**Playwright**](https://github.com/microsoft/playwright) ⭐ 96,698 | 🐛 183 | 🌐 TypeScript | 📅 2026-09-26 同 Puppeteer 团队出品，但区别是它支持 Chrome、Safari、Firefox、Edge
* [**ink**](https://github.com/vadimdemedes/ink) ⭐ 39,954 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-21 是一个 React 的命令行渲染器，命令行界面可以像写页面那么写了
* [**cheerio**](https://github.com/cheeriojs/cheerio) ⭐ 30,505 | 🐛 60 | 🌐 TypeScript | 📅 2026-09-25 用类 jQuery 语法处理 HTML
...
* [**enquirer**](https://github.com/nasa/openmct) ⭐ 13,135 | 🐛 1,091 | 🌐 JavaScript | 📅 2026-09-26 命令行 prompt 询问库，写 cli 的时候很有用
* [**yargs**](https://github.com/yargs/yargs) ⭐ 11,504 | 🐛 213 | 🌐 JavaScript | 📅 2026-09-24 命令行参数解析
...
* [**consola**](https://github.com/nuxt/consola) ⭐ 7,331 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-25 优雅的命令行 console logger `vuepress` 也使用了它
...
* [**fx**](https://github.com/antonmedv/fx) ⭐ 20,640 | 🐛 35 | 🌐 Go | 📅 2026-08-26 命令行优化 JSON 输出
...
* [**mkcert**](https://github.com/FiloSottile/mkcert) ⭐ 59,695 | 🐛 177 | 🌐 Go | 📅 2024-08-13 一键命令 让本地也支持 https
* [**algorithm-visualizer**](https://github.com/algorithm-visualizer/algorithm-visualizer) ⭐ 48,743 | 🐛 80 | 🌐 JavaScript | 📅 2024-06-09 算法代码可视化
* [**hyper**](https://github.com/zeit/hyper) ⭐ 44,744 | 🐛 1,049 | 🌐 TypeScript | 📅 2026-08-21 前端命令行
* [**outline**](https://github.com/outline/outline) ⭐ 40,711 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-26 一个免费开源的库，能让你快速搭建自己的 wiki
...
* [**https://github.com/artf/grapesjs**](https://github.com/artf/grapesjs) ⭐ 26,273 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-21 可视化建站工具 不需要写代码就能写一个页面，前端再次再次要下岗了
* [**docz**](https://github.com/pedronauck/docz) ⚠️ Archived 让你能快速写文档的一个库
* [**xterm.js**](https://github.com/xtermjs/xterm.js) ⭐ 21,226 | 🐛 276 | 🌐 TypeScript | 📅 2026-09-13 一个 web terminal
* [**eruda**](https://github.com/liriliri/eruda) ⭐ 21,202 | 🐛 84 | 🌐 JavaScript | 📅 2025-08-01 移动端调试工具
* [**bit**](https://github.com/teambit/bit) ⭐ 18,490 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-25 实现了项目之间的代码共享 可以自建私有
* [**mjml**](https://github.com/mjmlio/mjml) ⭐ 18,249 | 🐛 50 | 🌐 JavaScript | 📅 2026-09-25 一个让发 email 更简单的框架。定义了一套自己的语法，你用这套语法写邮件，然后编译成 HTML。
* [**verdaccio**](https://github.com/verdaccio/verdaccio) ⭐ 17,898 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-26 私有 npm
* [**leon**](https://github.com/leon-ai/leon) ⭐ 17,549 | 🐛 113 | 🌐 TypeScript | 📅 2026-09-26 你开源项目的 ai 个人助手
* [**vConsole**](https://github.com/Tencent/vConsole) ⭐ 17,529 | 🐛 50 | 🌐 TypeScript | 📅 2026-03-27 也是一个移动端调试工具 腾讯出品
* [**An-English-Guide-for-Programmers**](https://github.com/yujiangshui/An-English-Guide-for-Programmers) ⭐ 16,710 | 🐛 10 | 📅 2023-01-28 专为程序员编写的英语学习指南
...
* [**webpackbar**](https://github.com/nuxt/webpackbar) ⭐ 2,092 | 🐛 29 | 🌐 TypeScript | 📅 2026-09-26 webpack 打包进度条
...
* [**workbox**](https://github.com/googlechrome/workbox) ⭐ 13,022 | 🐛 70 | 🌐 JavaScript | 📅 2026-09-02 PWA 方案，Google 出品

## 请求处理

* [**axios**](https://github.com/axios/axios) ⭐ 109,220 | 🐛 96 | 🌐 JavaScript | 📅 2026-09-24 目前最常见的请求库
* [**request**](https://github.com/request/request) ⭐ 25,496 | 🐛 144 | 🌐 JavaScript | 📅 2024-08-14 老牌请求库 -[\*whatwg-fetch\*\*](https://github.com/github/fetch) ⭐ 25,848 | 🐛 23 | 🌐 JavaScript | 📅 2024-07-15 fetch 请求库
...
* [**eslint-config-airbnb**](https://github.com/airbnb/javascript) ⭐ 148,281 | 🐛 165 | 🌐 JavaScript | 📅 2026-04-16 airbnb 约束风格
* [**nvm**](https://github.com/creationix/nvm) ⭐ 95,186 | 🐛 392 | 🌐 Shell | 📅 2026-09-21 管理 node 版本
* [**prettier**](https://github.com/prettier/prettier) ⭐ 52,311 | 🐛 1,442 | 🌐 JavaScript | 📅 2026-09-24 更主观的风格自动修改
* [**lerna**](https://github.com/lerna/lerna) ⭐ 36,055 | 🐛 297 | 🌐 TypeScript | 📅 2026-09-26 monorepo 管理
* [**husky**](https://github.com/typicode/husky) ⭐ 35,333 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-19 添加 git hooks
* [**eslint**](https://github.com/eslint/eslint) ⭐ 27,516 | 🐛 126 | 🌐 JavaScript | 📅 2026-09-25 JS 风格约束
...
* [**npm-check**](https://github.com/dylang/npm-check) ⭐ 6,638 | 🐛 232 | 🌐 JavaScript | 📅 2026-09-26 检测依赖升级情况，我会和 `yarn upgrade-interactive` 配合着用，主要用来检测冗余依赖
...
* [**Motrix**](https://github.com/agalwood/Motrix) ⭐ 55,879 | 🐛 137 | 🌐 TypeScript | 📅 2026-09-26 支持 HTTP、FTP、BT、磁力链、百度网盘的下载工具
* [**more**](https://github.com/serhii-londar/open-source-mac-os-apps) ⭐ 50,569 | 🐛 301 | 📅 2026-09-10 更多优秀的 mac app 介绍
* [**IINA**](https://github.com/lhc70000/iina) ⭐ 46,497 | 🐛 1,941 | 🌐 Swift | 📅 2026-09-26 mac 平台感觉免费最好的播放器 强推
* [**hidden**](https://github.com/dwarvesf/hidden) ⭐ 14,986 | 🐛 123 | 🌐 Swift | 📅 2026-09-23 是用来帮助你隐藏 macOS 菜单栏上那些不常用的应用图标
...
* [**KeyCastr**](https://github.com/keycastr/keycastr) ⭐ 15,131 | 🐛 90 | 🌐 Objective-C | 📅 2026-09-07 按键显示，录制的时候显示你的按键

## Chrome 拓展

* [**refined-github**](https://github.com/sindresorhus/refined-github) ⭐ 32,221 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-26 优化 github 默认功能和样式的 chrome 插件
...
* [**FiraCode**](https://github.com/tonsky/firacode) ⭐ 82,060 | 🐛 428 | 🌐 Clojure | 📅 2026-07-28
* [**Dank Mono**](https://dank.sh/)
* [**Operator Mono**](https://www.typography.com/blog/introducing-operator)

## 编辑器和 Terminal

* Terminal 用 [**iTerm2**](https://www.iterm2.com/) + [**zsh**](https://en.wikipedia.org/wiki/Z_shell) + [**oh-my-zsh**](https://github.com/robbyrussell/oh-my-zsh) ⭐ 189,942 | 🐛 301 | 🌐 Shell | 📅 2026-09-23 的组合，主题是 [robbyrussell](https://github.com/robbyrussell/oh-my-zsh/blob/master/themes/robbyrussell.zsh-theme) ⭐ 189,942 | 🐛 301 | 🌐 Shell | 📅 2026-09-23
* [**Go2shell**](https://zipzapmac.com/Go2Shell) 在当前文件夹打开 shell

### zsh 插件

* [**autojump**](https://github.com/ohmyzsh/ohmyzsh/tree/master/plugins/autojump) ⭐ 189,942 | 🐛 301 | 🌐 Shell | 📅 2026-09-23 实现目录间快速跳转，想去哪个目录直接 j + 目录名，不用在频繁的 cd 了
* [**history**](https://github.com/ohmyzsh/ohmyzsh/tree/master/plugins/history) ⭐ 189,942 | 🐛 301 | 🌐 Shell | 📅 2026-09-23 命令行记录
* [**zsh-autosuggestions**](https://github.com/zsh-users/zsh-autosuggestions) ⭐ 36,095 | 🐛 203 | 🌐 Shell | 📅 2025-06-24 命令自动建议和补全
...
* [**Github Desktop**](https://github.com/desktop/desktop) ⭐ 21,905 | 🐛 1,048 | 🌐 TypeScript | 📅 2026-09-25管理 github 仓库的变更和 PR
* [**KeepingYouAwake**](https://github.com/newmarcel/KeepingYouAwake) ⭐ 6,941 | 🐛 30 | 🌐 Objective-C | 📅 2026-08-15 可保证系统不自动休眠，挂机跑脚本很有用
...
* [**build-your-own-x**](https://github.com/danistefanovic/build-your-own-x) ⭐ 549,768 | 🐛 645 | 🌐 Markdown | 📅 2026-07-14 教你用各种语言实现 Bot Database Neural Network
* [\*\*javascript-algorithms \*\*](https://github.com/trekhleb/javascript-algorithms) ⭐ 196,813 | 🐛 407 | 🌐 JavaScript | 📅 2026-07-26 教你用前端知识认识各种算法
* [**app-ideas**](https://github.com/florinpop17/app-ideas) ⭐ 97,779 | 🐛 604 | 📅 2025-10-11 很多年轻人苦于缺少练手的项目，这个项目收集了不少点子，每个点子都有明确的目标和复杂资源。
* [**WebGL-Fluid-Simulation**](https://github.com/PavelDoGreat/WebGL-Fluid-Simulation) ⭐ 16,662 | 🐛 74 | 🌐 JavaScript | 📅 2024-11-12 很酷的 WebGL 交互
...
* [**gitmoji**](https://github.com/carloscuesta/gitmoji) ⭐ 16,800 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-18 通过 emoji 表达 git 的操作内容
...
* [**feather**](https://github.com/feathericons/feather) ⭐ 26,006 | 🐛 510 | 🌐 JavaScript | 📅 2025-03-11 免费的 icons
...
* [**leetcode**](https://github.com/azl397985856/leetcode) ⭐ 55,734 | 🐛 13 | 🌐 JavaScript | 📅 2025-07-16 用 js 刷 leetcode
